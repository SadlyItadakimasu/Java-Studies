...
public class Contrato1 {
	...
	public static void main(String[] args) {
	    Scanner sc = new Scanner(System.in);
	     ...
	     System.out.println("Cláusula 2ª – O período de vigência do Contrato será de 30 (trinta) meses, a iniciar-se no dia");
	     System.out.printf("%s e a se encerrar em %s. Após o 12º (décimo segundo) mês de vigência da%n", DATAENTRADA, DATASAIDA);
	     System.out.println("locação o Locatário poderá rescindir o presente contrato sem o pagamento de multa, devendo");
	     System.out.println("comunicar a administradora por escrito com 30 (trinta) dias de antecedência");
	     System.out.printf("%nCláusula 3ª – Findo o prazo previsto no caput da cláusula 2ª, o Imóvel deverá ser devolvido nas%n");
	     System.out.println("mesmas condições que a LOCATÁRIA recebeu, efetivando-se com a entrega das chaves.");
	     System.out.printf("%nCláusula 4ª – Caso a LOCATÁRIA não restitua o Imóvel no fim do prazo contratual, pagará,%n");
	     System.out.println("enquanto estiver na posse do Imóvel, o aluguel mensal reajustado nos termos do quanto disposto");
	     System.out.println("neste Contrato, até a efetiva desocupação e entrega das chaves do Imóvel.");
	     System.out.printf("%nCláusula 5ª – A falta de pagamento dos aluguéis e encargos por período inferior a 30 dias, por si%n");
	     System.out.println("só, constituirá a LOCATÁRIA em mora, nos termos da Cláusula 6ª do Contrato,");
	     System.out.println("independentemente de qualquer aviso, notificação ou interpelação, sem prejuízo da incidência de");
	     ...
	     System.out.printf("%nCláusula 6ª – A LOCATÁRIA se compromete a pagar o aluguel no valor de R$ %.5f (%s reais)%n", VALORALUGUEL, VALOREXTENSO);
	     System.out.printf("pontualmente todo dia $d (%s) de cada mês vencido, bem como correção monetária,%n", DATAVENC, DATAVENCEXT);
